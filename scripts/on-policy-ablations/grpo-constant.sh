...
for seed in "${seeds[@]}"; do
    echo "Starting GRPO constant training with seed=${seed}"
    ...
    echo "Finished GRPO constant training with seed=${seed}"
done

echo "All four GRPO constant runs completed."
